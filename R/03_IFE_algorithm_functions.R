...
#' @param verbose when TRUE, it prints messages
define_object_for_initial_clustering_macropca <- function(robust, Y, g, k, kg, comfactor, method_estimate_beta = "individual", method_estimate_factors = "macro", verbose = FALSE) {
  TT <- ncol(Y)
